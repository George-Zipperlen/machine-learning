...
# changed 'TOTAL' to '_Total' -- forces column to sort to end
# should really be handled separately
heatmap_df0 = y_full.groupby('disease').sum().assign(_Total = unique_pos)
